...
export default function Rightbar({ about_me = {}, blog_list = [], imagePath }) {
  ...
  const content = about_me.value ? md.render(about_me.value) : "";
  ...
  return (
    <div className="flex flex-col sm:flex-row lg:flex-col gap-4">
      ...
      <div className="border bg-gray-100 w-full top-0 rounded-lg px-5 pb-5 flex flex-col gap-3">
        ...
        <div
          className="text-gray-600 text-center max-h-[300px] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
